...
var currentSec;
var currentMillisec; 
window.onload = () => (setInterval( 'updateTime()', 1000));     //숫자가 작을수록 부드럽게 로딩

function updateTime(){
var currentDate = new Date();       //현재시간
//@@@@@@@@@@@@@@@@@@@@@@
var g = $.createRadialGradient(250,250,.5,250,250,250);  //배경 그라데이션 색상
  g.addColorStop(0, 'hsla(180, 55%, 8%, 1)');       
  g.addColorStop(1, 'hsla(180, 95%, 15%, 1)');  
$.fillStyle = g;
$.fillRect( 0, 0, c.width, c.height );  //canvas 크기 만큼
currentSec = currentDate.getSeconds();      //초
currentMillisec = currentDate.getMilliseconds(); 
currentMin = currentDate.getMinutes();          //분
currentHr = currentDate.getHours();             //시간
...
$.moveTo( 250, 250 );       //시작지점
$.lineTo( 250, 50 );
$.arc( 250, 250, 200, calcDeg( 0 ), calcDeg( ang ), false );    //반지름200,시작각도,끝나는각도
$.lineTo( 250, 250 );
  $.shadowColor = 'hsla(180, 45%, 5%, .4)';     //음영
  $.shadowBlur =15;
  $.shadowOffsetX = 15;
  $.shadowOffsetY = 15;
$.fill();
